...
public class PortalControlador {
    ...
    public String actualizar(@RequestParam(required = false) MultipartFile archivo,@PathVariable String id, @RequestParam String nombre, @RequestParam String email, 
